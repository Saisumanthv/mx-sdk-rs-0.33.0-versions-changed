...
use super::{
    ...
    CheckStateStep, NewAddress, ScCallStep, ScDeployStep, ScQueryStep, SetStateStep, TxDCT,
    TxExpect, U64Value,
};
...
impl ScDeployStep {
    ...
    {
        self.tx.moax_value = BigUintValue::interpret_from(expr, &InterpreterContext::default());
        self
    }
...
impl ScCallStep {
        ...
        BigUintValue: InterpretableFrom<A>,
    {
        ...
        self.tx.moax_value = BigUintValue::interpret_from(amount, &InterpreterContext::default());
        self
    }
        ...
        BigUintValue: InterpretableFrom<A>,
    {
        ...
        self.tx.dct_value.push(TxDCT {
            dct_token_identifier: BytesValue::interpret_from(token_id, &ctx),
            nonce: U64Value::interpret_from(token_nonce, &ctx),
            dct_value: BigUintValue::interpret_from(amount, &ctx),
        });
