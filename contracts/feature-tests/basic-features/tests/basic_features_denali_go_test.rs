...
fn crypto_keccak256_legacy_managed_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_keccak256_legacy_managed.scen.json");
}
...
fn echo_managed_async_result_empty_go() {
    dharitri_wasm_debug::denali_go("denali/echo_managed_async_result_empty.scen.json");
}
...
fn echo_multi_value_tuples_go() {
    dharitri_wasm_debug::denali_go("denali/echo_multi_value_tuples.scen.json");
}
...
fn managed_buffer_concat_go() {
    dharitri_wasm_debug::denali_go("denali/managed_buffer_concat.scen.json");
}

#[test]
fn managed_buffer_copy_slice_go() {
    dharitri_wasm_debug::denali_go("denali/managed_buffer_copy_slice.scen.json");
}
...
fn storage_managed_address_go() {
    dharitri_wasm_debug::denali_go("denali/storage_managed_address.scen.json");
}
...
fn storage_mapper_fungible_token_go() {
    dharitri_wasm_debug::denali_go("denali/storage_mapper_fungible_token.scen.json");
}
...
fn storage_mapper_non_fungible_token_go() {
    dharitri_wasm_debug::denali_go("denali/storage_mapper_non_fungible_token.scen.json");
}
...
fn storage_mapper_whitelist_go() {
    dharitri_wasm_debug::denali_go("denali/storage_mapper_whitelist.scen.json");
}

#[test]
fn storage_opt_managed_addr_go() {
    dharitri_wasm_debug::denali_go("denali/storage_opt_managed_addr.scen.json");
}
