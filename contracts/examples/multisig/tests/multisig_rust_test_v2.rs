...
use dharitri_wasm::{
    dharitri_codec::multi_types::{MultiValueVec, OptionalValue},
...
impl MultisigTestState {
    ...
    fn multisig_propose_adder_deploy(&mut self, caller: &Address) -> usize {
        self.world.denali_set_state(SetStateStep::new().new_address(
            &self.multisig.denali_address_expr,
            0,
            &self.adder_multisig,
        ));
