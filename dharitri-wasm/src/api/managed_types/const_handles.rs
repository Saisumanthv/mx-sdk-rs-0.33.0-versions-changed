...
pub const CALL_VALUE_MOAX: Handle = -11;
pub const CALL_VALUE_SINGLE_DCT: Handle = -13;
...
pub const CALL_VALUE_MULTI_DCT: Handle = -21;
pub const CALL_VALUE_SINGLE_DCT_TOKEN_NAME: Handle = -22;
